 ...
 * @author: kiple
 */
public class KiplePayHostPagePaymentSampleSandbox {
    // #STEP1
    ...
    public static void main(String[] args) throws Exception {
      ...
      //  String url = "https://sandbox-api-ewallet.maxis.com.my/cashier/api/v1.0/checkout";
        String url = "http://47.254.245.66:10891/cashier/api/v1.0/host-page/init";
        ...
        String biz_content = "{" +
                "\"time_expire\":\"3600\"," +
                "\"third_part_id\":\"aaaaaaaaaaaaaaaaaaa\"," +
                "\"pay_type\":\"PAY\"," +     //PAY or TP
                "\"specified_channel\":\"WALLET\"," + //CC  WALLET FPX
                "\"order_ref\": \""+merchantOrderNumber+"\"," +
                "\"order_amount\":300," +
                "\"ip_address\":\"192.168.1.131\"," +
                "\"notify_url\": \"http://192.168.1.162:8082/kiplepay/payment/server/notification\"," +
