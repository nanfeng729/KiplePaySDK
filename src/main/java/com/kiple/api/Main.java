package main.java.com.kiple.api;
...
public class Main {
    ...
    public static class SandBox {
        ...
        public static final String GATEWAY = "http://47.254.245.66/user/api/v1.0/users/profile";
    }
    /**
    ...
    public static void main(String[] agrs) throws KiplePayApiException {
        ...
        KiplePayClient kiplePayClient = new DefaultKiplePayClient(SandBox.GATEWAY,
                ...
                SandBox.sign_type);
        KiplePayFormRequest request = new KiplePayFormRequest();
        request.setApiVersion("1.0.0");
//        request.setBizContent("{\"pin\":\"" + 2 + "\"," + "\"user_id\":29}");
//        request.setBizContent("{\"latitude\":\"263\"}");
        request.setBizContent("{\"device_id\":\"9850954\"," + "\"device_model\":\"9987665\"," + "\"ip_address\":\"123\"," +
                "\"latitude\":\"345\","+
                "\"longitude\":\"3456\"}");
//
//        request.setNotifyUrl(SandBox.notify_url);
//        request.setReturnUrl(SandBox.return_url);
        request.setToken("8f4158d6d5864e65a79f6d0a0a6045d5");
//        request.addHeader("token","1893bec1-a245-472a-a779-2656fd5dd6e3");
        long start_time = System.currentTimeMillis();
        final KiplePayResponse<JSONObject> kiplePayResponse = kiplePayClient.execute(request,"get");
