...
public class FormFileTest {
    ...
    public static class SandBox {
        ...
        public static final String GATEWAY = "http://47.254.245.66/user/api/v1.0/ekyc/nric";
    }
    ...
    public static void main(String agrs[]) throws KiplePayApiException {
        ...
        //参数
        request.setBizContent("{\"device_id\":\"9856654\",\"device_model\":\"098765\",\"ip_address\":\"192.168.1.1\"" +
                ",\"latitude\":\"263\",\"longitude\":\"2543\"}");
        request.setToken("4071f6e0-cf02-4905-b3ee-2f34eeba88bc");
